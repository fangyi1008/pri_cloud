package com.yitech.cloud.license.service;
...
import com.yitech.cloud.license.utils.CommonUtils;
...
public abstract class AServerInfos {
	private static Logger log = LoggerFactory.getLogger(AServerInfos.class);
