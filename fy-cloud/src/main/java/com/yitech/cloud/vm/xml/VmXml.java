package com.yitech.cloud.vm.xml;
...
import com.yitech.cloud.vm.xml.domain.ClockXml;
import com.yitech.cloud.vm.xml.domain.PoolXml;
...
import com.yitech.cloud.vm.xml.domain.cpu.model.CpuModelXml;
import com.yitech.cloud.vm.xml.domain.cpu.numa.NumaXml;
import com.yitech.cloud.vm.xml.domain.cpu.numa.cell.CellXml;
import com.yitech.cloud.vm.xml.domain.cpu.topology.TopologyXml;
...
import com.yitech.cloud.vm.xml.domain.devices.Interface.InterfaceXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.driver.DriversXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.hotpluggable.HotpluggablesXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.mac.MacXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.mtu.MtuXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.priority.PriorityXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.source.Source1Xml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.virtualport.VirtualPortXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.virtualport.parameters.ParametersXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.vlan.VlanXml;
import com.yitech.cloud.vm.xml.domain.devices.Interface.vlan.tag.TagXml;
import com.yitech.cloud.vm.xml.domain.devices.channel.ChannelXml;
...
import com.yitech.cloud.vm.xml.domain.devices.console.ConsoleXml;
import com.yitech.cloud.vm.xml.domain.devices.console.target.TargetsXml;
import com.yitech.cloud.vm.xml.domain.devices.controller.ControllerXml;
import com.yitech.cloud.vm.xml.domain.devices.disk.DiskCdXml;
import com.yitech.cloud.vm.xml.domain.devices.disk.DiskXml;
import com.yitech.cloud.vm.xml.domain.devices.disk.DisksXml;
...
import com.yitech.cloud.vm.xml.domain.devices.disk.hotpluggable.HotpluggableXml;
...
import com.yitech.cloud.vm.xml.domain.devices.graphics.GraphicsXml;
import com.yitech.cloud.vm.xml.domain.devices.graphics.listen.ListenXml;
import com.yitech.cloud.vm.xml.domain.devices.hub.HubXml;
import com.yitech.cloud.vm.xml.domain.devices.input.InputXml;
import com.yitech.cloud.vm.xml.domain.devices.memballoon.MemballoonXml;
import com.yitech.cloud.vm.xml.domain.devices.serial.SerialXml;
...
import com.yitech.cloud.vm.xml.domain.devices.video.VideoXml;
