...
import com.yitech.cloud.monitor.entity.ClusterMonitorEntity;
import com.yitech.cloud.monitor.job.ClusterMonitorJob;
import com.yitech.cloud.monitor.service.ClusterMonitorService;
/**
 * 集群资源统计接口实现
 * @author fangyi
 *
