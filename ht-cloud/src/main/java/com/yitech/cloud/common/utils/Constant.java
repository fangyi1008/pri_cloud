...
public class Constant {
	 ...
	 * 数据库加密盐值
	 */
	public static String JASYPT_ENCRYPTOR_VALUE="yitech_cloud_db";
	
	/**
	 * 存储卷基础路径
	 */
	public static String STORAGE_VOLUME_BASE_PATH = "/yitech/volume/";
	 ...
	 * 虚拟机模板基础路径
	 */
	public static String VM_TEMPLATE_PATH = "/yitech/";
	/**
	 * AES key
	 */
