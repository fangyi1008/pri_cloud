 ...
 * @Time 2022年5月11日
 */
package com.hontosec.cloud.common.utils.poi;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.hontosec.cloud.common.annotation.Excel;
import com.hontosec.cloud.common.annotation.Excel.ColumnType;
import com.hontosec.cloud.common.annotation.Excel.Type;
import com.hontosec.cloud.common.annotation.Excels;
import com.hontosec.cloud.common.config.CloudConfig;
import com.hontosec.cloud.common.exception.UtilException;
import com.hontosec.cloud.common.utils.DateUtils;
import com.hontosec.cloud.common.utils.Result;
import com.hontosec.cloud.common.utils.StringUtils;
import com.hontosec.cloud.common.utils.file.FileTypeUtils;
import com.hontosec.cloud.common.utils.file.FileUtils;
import com.hontosec.cloud.common.utils.file.ImageUtils;
import com.hontosec.cloud.common.utils.reflect.ReflectUtils;
import com.hontosec.cloud.common.utils.text.Convert;
import com.hontosec.cloud.common.utils.uuid.UUID;
...
public class ExcelUtil <T> {
	...
	public void setCellVo(Object value, Excel attr, Cell cell) {
		if (ColumnType.STRING == attr.cellType()) {
			...
			if (StringUtils.containsAny(cellValue, FORMULA_STR)) {
				cellValue = StringUtils.replaceEach(cellValue, FORMULA_STR,
						new String[] { "\t=", "\t-", "\t+", "\t@" });
			}
	...
	public String getAbsoluteFile(String filename) {
		String downloadPath = CloudConfig.getDownloadPath() + filename;
