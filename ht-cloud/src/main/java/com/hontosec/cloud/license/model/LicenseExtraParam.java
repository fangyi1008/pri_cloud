package com.hontosec.cloud.license.model;
...
public class LicenseExtraParam implements Serializable {
    ...
    /** 限制系统中可注册的人数*/
    private Long registerAmount = 0L;
    /**限制主机数量*/
    ...
    public Long getHostAmount() {
		return hostAmount;
	}

	public void setHostAmount(Long hostAmount) {
		this.hostAmount = hostAmount;
	}

	public boolean isIshostCheck() {
		return ishostCheck;
	}

	public void setIshostCheck(boolean ishostCheck) {
