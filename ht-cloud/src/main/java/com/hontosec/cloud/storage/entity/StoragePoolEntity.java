 ...
 * @Time 2022年5月7日
 */
package com.hontosec.cloud.storage.entity;
 ...
 *
 */
@TableName("storage_pool_table")
@ApiModel(value = "存储池实体",description = "存储池实体")
public class StoragePoolEntity implements Serializable{
